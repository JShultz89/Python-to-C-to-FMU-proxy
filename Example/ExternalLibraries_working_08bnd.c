...
int ExternalLibraries_working_updateBoundVariableAttributes(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int ExternalLibraries_working_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH

...
void ExternalLibraries_working_callExternalObjectConstructors(DATA *data, threadData_t *threadData)
{
...
void ExternalLibraries_working_callExternalObjectDestructors(DATA *data, threadData_t *threadData)
{
